...
def setAugmentationParams(saveDir):
    config_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "YOLOv11_config.yaml")
    ...
    config['fliplr']=0.5 # image flip left-right (probability)
    ...
    config['mixup']=0.4 # image mixup (probability)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('YOLOv11 training script', parents=[get_arguments()])
